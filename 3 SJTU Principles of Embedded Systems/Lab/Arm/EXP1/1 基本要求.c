...
uint32_t delay_time,key_value,time;
...
int main(void)
{
	//	to use 16-MHz precision	internal oscillator for 40MHz
	//time = SysCtlClockFreqSet(SYSCTL_OSC_INT | SYSCTL_USE_PLL | SYSCTL_CFG_VCO_320, 40000000);

	//	to use an external crystal or oscillator for 20MHz
